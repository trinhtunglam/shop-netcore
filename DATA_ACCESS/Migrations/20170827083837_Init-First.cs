        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    Email = table.Column<string>(maxLength: 256, nullable: true),
                    Fax = table.Column<string>(maxLength: 256, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(nullable: false),
                    Quantity = table.Column<int>(nullable: false),
                    ReceiptNodeId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReceiptNoteDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReceiptNoteDetails_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReceiptNoteDetails_ReceiptNotes_ReceiptNodeId",
                        column: x => x.ReceiptNodeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReceiptNoteDetails_ProductId",
                table: "ReceiptNoteDetails",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ReceiptNoteDetails_ReceiptNodeId",
                table: "ReceiptNoteDetails",
                column: "ReceiptNodeId");
